...
namespace FishingScheduler
{
        ...
        : Window
    {
        ...
        private void InitializeData()
        {
            ...
            {
                // リムサ・ロミンサ
                new Fish("ゴールデンフィン", ToFishingSpot( "リムサ・ロミンサ：上甲板層"), ToFishingBait("ピルバグ"), 9, 14),
                new Fish("メガオクトパス", ToFishingSpot( "リムサ・ロミンサ：下甲板層"), ToFishingBait("ピルバグ"), 9, 17, "ピルバグ⇒(プレ)メルトールゴビー/ハーバーヘリングHQ⇒(スト)"),

                // 中央ラノシア
                new Fish("ザルエラ", ToFishingSpot( "ゼファードリフト沿岸"), ToFishingBait("ラットの尾"), 9, 14),
                new Fish("トリックスター", ToFishingSpot( "ローグ川"), ToFishingBait("モスプパ"), 9, 14),
                new Fish("スナガクレ", ToFishingSpot( "西アジェレス川"), ToFishingBait("ザリガニボール")),
                new Fish("ギガシャーク", ToFishingSpot( "サマーフォード沿岸"), ToFishingBait("ピルバグ"), WeatherType.快晴 | WeatherType.晴れ, "ラグワーム⇒ワフーHQ⇒"),
                new Fish("ハイパーチ", ToFishingSpot( "ニーム川"), ToFishingBait("シンキングミノー"), 5, 8),
                new Fish("クリスタルパーチ", ToFishingSpot( "ささやきの谷"), ToFishingBait("バターワーム"), WeatherType.曇り | WeatherType.霧 | WeatherType.風),

                // 低地ラノシア
                new Fish("オオゴエナマズ", ToFishingSpot( "モーニングウィドー"), ToFishingBait("モスプパ")),
                new Fish("オシュオンプリント", ToFishingSpot( "モラビー湾西岸"), ToFishingBait("ゴビーボール")),
                new Fish("シルドラ", ToFishingSpot( "シダーウッド沿岸部"), ToFishingBait("スプーンワーム"), WeatherType.雨),
                new Fish("マヒマヒ", ToFishingSpot( "オシュオン灯台"), ToFishingBait("弓角"), 10, 18),
                new Fish("シルバーソブリン", ToFishingSpot( "オシュオン灯台"), ToFishingBait("弓角")),
                new Fish("サーベルタイガーコッド", ToFishingSpot( "キャンドルキープ埠頭"), ToFishingBait("ゴビーボール"), 16, 22),
                new Fish("ザ・リッパー", ToFishingSpot( "モラビー造船廠"), ToFishingBait("ゴビーボール"), 21, 3),
                new Fish("フェアリークィーン", ToFishingSpot( "エンプティハート"), ToFishingBait("スピナー"), WeatherType.曇り | WeatherType.霧 | WeatherType.風),
                new Fish("メテオサバイバー", ToFishingSpot( "ソルトストランド"), ToFishingBait("ラットの尾"), 3, 5, WeatherType.曇り | WeatherType.風 | WeatherType.霧),
                new Fish("オヤジウオ", ToFishingSpot( "ブラインドアイアン坑道"), ToFishingBait("ハナアブ"), 17, 19),
                ...
                new Fish(
                    ...
                    WeatherType.雨),
                new Fish("ビアナックブーン", ToFishingSpot( "南ブラッドショア"), ToFishingBait("シュリンプフィーダー"), 20, 23),
                ...
                new Fish("ボンバードフィッシュ", ToFishingSpot( "北ブラッドショア"), ToFishingBait("ヘリングボール"), 9, 15, WeatherType.快晴),
                new Fish("オールドマーリン", ToFishingSpot( "ロータノ海沖合：船首"), ToFishingBait("ピルバグ"), WeatherType.雨 | WeatherType.暴雨, WeatherType.快晴, "ピルバグ⇒ハーバーヘリングHQ⇒オーガバラクーダHQ⇒"),
                new Fish("ネプトの竜", ToFishingSpot( "ロータノ海沖合：船尾"), ToFishingBait("ポーラークリル"), WeatherType.雨 | WeatherType.暴雨, "(要リトルサラオス×3) ポーラークリル⇒\nポーラークリル⇒"),
                new Fish("ソルター", ToFishingSpot( "隠れ滝"), ToFishingBait("ハニーワーム"), 17, 20, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("ドラウンドスナイパー", ToFishingSpot( "東アジェレス川"), ToFishingBait("スナーブルフライ"), WeatherType.快晴 | WeatherType.晴れ),
                new Fish("テルプシコレアン", ToFishingSpot( "レインキャッチャー樹林"), ToFishingBait("ハニーワーム"), WeatherType.霧),
                ...
                // 西ラノシア
                new Fish("スケーリーフット", ToFishingSpot( "スウィフトパーチ入植地"), ToFishingBait("ポーラークリル"), 19, 3),
                new Fish("ジャンクモンガー", ToFishingSpot( "スカルバレー沿岸部"), ToFishingBait("ピルバグ"), 16, 2, "ピルバグ⇒(プレ)メルトールゴビーHQ⇒(スト)ワフーHQ⇒(スト)"),
                new Fish("リムレーンズソード", ToFishingSpot( "ブルワーズ灯台"), ToFishingBait("弓角"), 9, 14, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("ローンリッパー", ToFishingSpot( "ハーフストーン沿岸部"), ToFishingBait("ヘヴィメタルジグ"), WeatherType.暴風),
                ...
                new Fish("キャプテンズチャリス", ToFishingSpot( "サプサ産卵地"), ToFishingBait("メタルジグ"), 23, 2, "メタルジグ⇒フルムーンサーディンHQ⇒"),
                new Fish("コエラカントゥス", ToFishingSpot( "幻影諸島南岸"), ToFishingBait("スプーンワーム"), 22, 3, WeatherType.曇り | WeatherType.風 | WeatherType.霧, "スプーンワーム⇒フルムーンサーディンHQ⇒"),
                new Fish("エンドセラス", ToFishingSpot( "幻影諸島南岸"), ToFishingBait("スプーンワーム"), 20, 4, WeatherType.快晴 | WeatherType.晴れ, WeatherType.曇り | WeatherType.風 | WeatherType.霧, "スプーンワーム⇒フルムーンサーディンHQ⇒"),
                ...
                new Fish("ジャンヌ・トラウト", ToFishingSpot( "愚か者の滝"), ToFishingBait("クロウフライ"), 4, 6),
                new Fish("ワーム・オブ・ニーム", ToFishingSpot( "ブロンズレイク・シャロー"), ToFishingBait("バターワーム"), 19, 22),
                new Fish("スプリングキング", new []{ ToFishingSpot( "ブロンズレイク北東岸"), ToFishingSpot( "ブロンズレイク北西岸") }, ToFishingBait("スピナーベイト"), 16, 19),

                // 外地ラノシア
                new Fish("大鈍甲", ToFishingSpot( "ロングクライム渓谷"), ToFishingBait("スピナーベイト"), 4, 9),
                new Fish("サンダーガット", ToFishingSpot( "ロングクライム渓谷"), ToFishingBait("テッポウムシ"), 19, 3, WeatherType.雨),
                // スプリングキング (ブロンズレイク北西岸)
                ...
                // グリダニア
                new Fish("雨乞魚", new[]{ ToFishingSpot( "グリダニア：翡翠湖畔"), ToFishingSpot( "グリダニア：囁きの渓谷") }, ToFishingBait("テッポウムシ"), 17, 2, WeatherType.雨),
                new Fish("招嵐王", ToFishingSpot( "グリダニア：翡翠湖畔"), ToFishingBait("テッポウムシ"), 17, 2, WeatherType.雨),
                new Fish("ブラッディブルワー", ToFishingSpot( "グリダニア：紅茶川水系下流"), ToFishingBait("ザリガニボール")),
                new Fish("マトロンカープ", ToFishingSpot( "グリダニア：囁きの渓谷"), ToFishingBait("ブラッドワーム"), 15, 21),
                new Fish("意地ブナ", ToFishingSpot( "グリダニア：紅茶川水系上流"), ToFishingBait("クロウフライ"), 9, 14, WeatherType.曇り | WeatherType.霧),

                // 中央森林
                new Fish("カイラージョン", ToFishingSpot( "葉脈水系"), ToFishingBait("モスプパ"), "モスプパ⇒ゼブラゴビーHQ⇒"),
                new Fish("人面魚", ToFishingSpot( "鏡池"), ToFishingBait("バターワーム"), 21, 3, WeatherType.雨),
                new Fish(
                    "ブラックイール",
                    new[]
                    {
                    ...
                    17,
                    10),
                new Fish("レヴィンライト", ToFishingSpot( "エバーシェイド"), ToFishingBait("ハナアブ"), 18, 23),
                new Fish("グリーンジェスター", ToFishingSpot( "芽吹の池"), ToFishingBait("ハニーワーム"), 18, 21),
                ...
                new Fish("ターミネーター", ToFishingSpot( "十二神大聖堂"), ToFishingBait("バターワーム"), 21, 23),
                ...
                new Fish(
                    ...
                    17,
                    10),
                new Fish("マッシュルームクラブ", ToFishingSpot( "シルフランド渓谷"), ToFishingBait("スピナー"), WeatherType.曇り | WeatherType.霧, "スピナー⇒スカルピンHQ⇒"),
                new Fish("マジック・マッシュルームクラブ", ToFishingSpot( "シルフランド渓谷"), ToFishingBait("スピナー"), WeatherType.雨 | WeatherType.雷, WeatherType.曇り | WeatherType.霧, "スピナー⇒スカルピンHQ⇒"),

                // 南部森林
                new Fish("ビッグバイパー", ToFishingSpot( "ハズーバ支流：上流"), ToFishingBait("バターワーム"), 18, 19),
                new Fish("フローティングボルダー", ToFishingSpot( "ハズーバ支流：下流"), ToFishingBait("バスボール"), 0, 8, WeatherType.曇り | WeatherType.霧),
                new Fish("グリナー", ToFishingSpot( "ハズーバ支流：東"), ToFishingBait("ハナアブ")),
                new Fish("シンカー", ToFishingSpot( "ハズーバ支流：中流"), ToFishingBait("シンキングミノー"), 21, 3, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("ゴブスレイヤー", ToFishingSpot( "ゴブリン族の生簀"), ToFishingBait("ハニーワーム"), WeatherType.雷 | WeatherType.雷雨, "ハニーワーム⇒銀魚HQ⇒"),
                new Fish("雷神魚", ToFishingSpot( "根渡り沼"), ToFishingBait("カディスラーヴァ"), WeatherType.雷雨 | WeatherType.雷),
                new Fish("雷皇子", ToFishingSpot( "根渡り沼"), ToFishingBait("カディスラーヴァ"), WeatherType.雷雨),
                new Fish("オオタキタロ", ToFishingSpot( "ウルズの恵み"), ToFishingBait("グロウワーム"), WeatherType.雷 | WeatherType.雷雨),
                new Fish("ナミタロ", ToFishingSpot( "ウルズの恵み"), new[]{ ToFishingBait("グロウワーム"), ToFishingBait("トップウォーターフロッグ") }, WeatherType.雷 | WeatherType.雷雨, "(要オオタキタロ×1, 雷雨) グロウワーム⇒\n(天候不問) トップウォーターフロッグ⇒"),

                // 北部森林
                new Fish("ブルーウィドー", ToFishingSpot( "さざめき川"), ToFishingBait("フローティングミノー"), 9, 14),
                new Fish("ジャッジレイ", ToFishingSpot( "フォールゴウド秋瓜湖畔"), ToFishingBait("フェザントフライ"), 17, 21),
                new Fish("シャドーストリーク", ToFishingSpot( "プラウドクリーク"), ToFishingBait("トップウォーターフロッグ"), 4, 10, WeatherType.霧),
                new Fish("コーネリア", ToFishingSpot( "タホトトル湖畔"), new[]{ ToFishingBait("レインボースプーン"), ToFishingBait("グロウワーム") }, "(要ボクシングプレコ×5) グロウワーム⇒\nレインボースプーン⇒"),

                // ラベンダーベッド
                new Fish("スウィートニュート", ToFishingSpot( "ラベンダーベッド"), ToFishingBait("ユスリカ"), 23, 4, WeatherType.霧, "ユスリカ⇒(プレ)グラディエーターベタHQ⇒(スト)"),

                // 西ザナラーン
                new Fish("銅鏡", ToFishingSpot( "ノフィカの井戸"), ToFishingBait("バターワーム"), WeatherType.快晴 | WeatherType.晴れ),
                new Fish("マッドゴーレム", ToFishingSpot( "足跡の谷"), ToFishingBait("バターワーム"), 21, 3),
                new Fish("リベットオイスター", ToFishingSpot( "ベスパーベイ"), ToFishingBait("ヘヴィメタルジグ")),
                new Fish("フィンガーズ", ToFishingSpot( "クレセントコーヴ"), ToFishingBait("ポーラークリル"), 17, 18),
                new Fish("ダーティーヘリング", ToFishingSpot( "シルバーバザー"), ToFishingBait("ポーラークリル"), 20, 22),
                ...
                // 中央ザナラーン
                new Fish("ドリームゴビー", ToFishingSpot( "スートクリーク上流"), ToFishingBait("ザリガニボール"), 17, 3),
                new Fish("ヌルヌルキング", ToFishingSpot( "スートクリーク下流"), ToFishingBait("ブラッドワーム"), 19, 0),
                new Fish("オールドソフティ", ToFishingSpot( "クラッチ狭間"), ToFishingBait("ブラッドワーム"), 17, 21),
                new Fish("ダークナイト", ToFishingSpot( "アンホーリーエアー"), ToFishingBait("クロウフライ"), WeatherType.砂塵 | WeatherType.曇り | WeatherType.霧),

                // 東ザナラーン
                new Fish("ジンコツシャブリ", ToFishingSpot( "ドライボーン北湧水地"), ToFishingBait("ハナアブ"), 20, 3, WeatherType.雨 | WeatherType.暴雨),
                new Fish("マッドピルグリム", ToFishingSpot( "ドライボーン南湧水地"), ToFishingBait("ユスリカ"), 17, 7, WeatherType.雨 | WeatherType.暴雨),
                new Fish("ナルザルイール", ToFishingSpot( "ユグラム川"), ToFishingBait("ハニーワーム"), 17, 10),
                new Fish("ワーデンズワンド", ToFishingSpot( "ユグラム川"), ToFishingBait("ハニーワーム"), 17, 20, WeatherType.快晴),
                new Fish("サンディスク", ToFishingSpot( "バーニングウォール"), ToFishingBait("カディスラーヴァ"), 10, 15, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("サウザンドイヤー・イーチ", ToFishingSpot( "バーニングウォール"), ToFishingBait("テッポウムシ"), WeatherType.霧),

                // 南ザナラーン
                new Fish("ホローアイズ", ToFishingSpot( "リザードクリーク"), ToFishingBait("ユスリカ"), WeatherType.霧, "ユスリカ⇒(プレ)銅魚HQ⇒(スト)"),
                new Fish("パガルザンディスカス", ToFishingSpot( "ザハラクの湧水"), ToFishingBait("グロウワーム"), WeatherType.灼熱波 | WeatherType.快晴 | WeatherType.晴れ),
                new Fish("ディスコボルス", ToFishingSpot( "ザハラクの湧水"), ToFishingBait("グロウワーム"), 12, 18, WeatherType.灼熱波),
                new Fish("アイアンヌース", ToFishingSpot( "忘れられたオアシス"), ToFishingBait("スピナー"), WeatherType.霧),
                new Fish("ホーリーカーペット", ToFishingSpot( "サゴリー砂海"), ToFishingBait("サンドリーチ"), 9, 16, WeatherType.灼熱波, "サンドリーチ⇒(スト)サンドストームライダーHQ⇒(スト)"),
                new Fish("ヘリコプリオン", ToFishingSpot( "サゴリー砂海"), ToFishingBait("サンドリーチ"), 8, 20, WeatherType.曇り | WeatherType.霧, WeatherType.灼熱波, "サンドリーチ⇒(スト)サンドストームライダー⇒(スト)"),
                new Fish("オルゴイコルコイ", ToFishingSpot( "サゴリー砂丘"), ToFishingBait("サンドリーチ"), WeatherType.灼熱波, "サンドリーチ⇒サンドストームライダーHQ⇒"),

                // 北ザナラーン
                new Fish("ハンニバル", ToFishingSpot( "ブルーフォグ湧水地"), ToFishingBait("スピナーベイト"), 22, 4, WeatherType.霧, "スピナーベイト⇒(プレ)スカルピンHQ⇒(スト)"),
                new Fish("ウーツナイフ・ゼニス", ToFishingSpot( "青燐泉"), ToFishingBait("ハニーワーム"), 1, 4, WeatherType.快晴 | WeatherType.晴れ, WeatherType.霧, "ハニーワーム⇒銀魚HQ⇒"),

                // ゴブレットビュート
                new Fish("スピアノーズ", ToFishingSpot( "ゴブレットビュート"), ToFishingBait("カディスラーヴァ"), 21, 0, WeatherType.曇り | WeatherType.霧),

                // クルザス中央高地
                new Fish("ダナフェンズマーク", ToFishingSpot( "クルザス川"), ToFishingBait("フェザントフライ"), WeatherType.吹雪),
                new Fish("カローンズランタン", ToFishingSpot( "聖ダナフェンの旅程"), ToFishingBait("グロウワーム"), 0, 4, WeatherType.吹雪 | WeatherType.雪),
                new Fish("スターブライト", ToFishingSpot( "剣ヶ峰山麓"), ToFishingBait("ハナアブ"), 21, 4, WeatherType.快晴 | WeatherType.晴れ, "ハナアブ⇒(プレ)アバラシアスメルトHQ⇒(スト)"),
                new Fish("ドーンメイデン", ToFishingSpot( "キャンプ・ドラゴンヘッド溜池"), ToFishingBait("フェザントフライ"), 5, 7, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("メイトリアーク", ToFishingSpot( "調査隊の氷穴"), ToFishingBait("ハナアブ"), "ハナアブ⇒(プレ)アバラシアスメルトHQ⇒(プレ)"),
                new Fish("ダークスター", ToFishingSpot( "聖ダナフェンの落涙"), new[]{ ToFishingBait("ハニーワーム"), ToFishingBait("チョコボフライ") }, 19, 4, WeatherType.吹雪 | WeatherType.雪, "(要ランプマリモ×5) チョコボフライ⇒\nハニーワーム⇒(プレ)アバラシアスメルトHQ⇒(スト)"),
                new Fish("ブルーコープス", ToFishingSpot( "スノークローク大氷壁"), ToFishingBait("カディスラーヴァ"), WeatherType.雪 | WeatherType.吹雪, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("アノマロカリス", ToFishingSpot( "イシュガルド大雲海"), ToFishingBait("ホバーワーム"), 10, 15, WeatherType.快晴 | WeatherType.晴れ, "ホバーワーム⇒スプリットクラウドHQ⇒"),
                ...
                new Fish("ショニサウルス", ToFishingSpot( "ウィッチドロップ"), ToFishingBait("ホバーワーム"), WeatherType.吹雪, "ホバーワーム⇒スプリットクラウドHQ⇒マハールHQ⇒"),

                // クルザス西部高地
                new Fish("クルザスパファー", ToFishingSpot( "リバーズミート"), ToFishingBait("ブルートリーチ"), WeatherType.雪 | WeatherType.吹雪),
                new Fish("ファットパース", ToFishingSpot( "リバーズミート"), ToFishingBait("ブルートリーチ")),
                new Fish("グレイシャーコア", ToFishingSpot( "グレイテール滝"), ToFishingBait("ジャンボガガンボ"), WeatherType.雪 | WeatherType.吹雪),
                new Fish("ハイウィンドジェリー", ToFishingSpot( "グレイテール滝"), ToFishingBait("ジャンボガガンボ"), WeatherType.晴れ | WeatherType.快晴, "(要フィッシュアイ) ジャンボガガンボ⇒スカイワームHQ⇒"),
                new Fish("アイスイーター", ToFishingSpot( "グレイテール滝"), ToFishingBait("ジャンボガガンボ"), WeatherType.雪 | WeatherType.吹雪, "ジャンボガガンボ⇒グレイシャーコアHQ⇒\n"),
                new Fish("ヘイルイーター", ToFishingSpot( "グレイテール滝"), ToFishingBait("ジャンボガガンボ"), WeatherType.吹雪, "ジャンボガガンボ⇒グレイシャーコアHQ⇒(プレ)\n"),
                new Fish("ソーサラーフィッシュ", ToFishingSpot( "クルザス不凍池"), ToFishingBait("ゴブリンジグ"), 8, 20),
                new Fish("ホワイトオクトパス", ToFishingSpot( "クルザス不凍池"), ToFishingBait("ブルートリーチ"), 8, 18),
                new Fish("クルザスクリオネ", ToFishingSpot( "クルザス不凍池"), ToFishingBait("ブルートリーチ"), 0, 4, WeatherType.吹雪),
                new Fish("フレアフィッシュ", ToFishingSpot( "クルザス不凍池"), ToFishingBait("ツチグモ"), 10, 16, WeatherType.吹雪, "ツチグモ⇒(プレ)ハルオネHQ⇒(スト)"),
                new Fish("ヒートロッド", ToFishingSpot( "クリアプール"), ToFishingBait("ブルートリーチ"), WeatherType.吹雪 | WeatherType.雪),
                new Fish("カペリン", ToFishingSpot( "クリアプール"), ToFishingBait("ブルートリーチ"), 0, 6, "(要フィッシュアイ)"),
                new Fish("プリーストフィッシュ", ToFishingSpot( "クリアプール"), ToFishingBait("ブルートリーチ"), 0, 6, "(要フィッシュアイ)"),
                new Fish("ビショップフィッシュ", ToFishingSpot( "クリアプール"), ToFishingBait("ブルートリーチ"), 10, 14, WeatherType.吹雪 | WeatherType.雪, WeatherType.快晴, "(要フィッシュアイ)"),
                new Fish("シャリベネ", ToFishingSpot( "クリアプール"), ToFishingBait("ツチグモ"), 0, 3, WeatherType.吹雪, "(要ハルオネ×5) ツチグモ⇒\nツチグモ⇒ハルオネHQ⇒"),
                new Fish("イエティキラー", ToFishingSpot( "ドラゴンスピット"), ToFishingBait("ブルートリーチ"), "(要引っ掛け釣り)"),
                new Fish("ベーンクラーケン", ToFishingSpot( "ベーンプール南"), ToFishingBait("ブルートリーチ"), WeatherType.吹雪 | WeatherType.雪 | WeatherType.曇り | WeatherType.霧, "(要フィッシュアイ)"),
                new Fish("ネモ", ToFishingSpot( "ベーンプール南"), ToFishingBait("ブルートリーチ"), WeatherType.雪, WeatherType.吹雪),
                new Fish("ラ・レアル", ToFishingSpot( "アッシュプール"), ToFishingBait("ブルートリーチ")),
                new Fish("氷神魚", ToFishingSpot( "ベーンプール西"), ToFishingBait("ブルートリーチ"), WeatherType.雪 | WeatherType.吹雪),
                new Fish("雪乞魚", ToFishingSpot( "ベーンプール西"), ToFishingBait("ブルートリーチ"), WeatherType.雪 | WeatherType.吹雪),
                ...
                // モードゥナ
                new Fish("ヘリオバティス", ToFishingSpot( "銀泪湖北岸"), ToFishingBait("カディスラーヴァ"), 17, 9),
                new Fish("エーテルラウス", ToFishingSpot( "銀泪湖北岸"), ToFishingBait("グロウワーム"), 3, 13, WeatherType.妖霧),
                new Fish("インフェルノホーン", ToFishingSpot( "タングル湿林源流"), ToFishingBait("グロウワーム"), WeatherType.妖霧, WeatherType.晴れ | WeatherType.快晴),
                new Fish("血紅龍", ToFishingSpot( "唄う裂谷"), ToFishingBait("ハニーワーム"), 4, 12, WeatherType.快晴 | WeatherType.晴れ, WeatherType.霧, "ハニーワーム⇒(プレ)銀魚HQ⇒(スト)"),
                new Fish("ヴォイドバス", ToFishingSpot( "早霜峠"), ToFishingBait("グロウワーム"), WeatherType.快晴 | WeatherType.晴れ, WeatherType.妖霧),
                new Fish("腐魚", ToFishingSpot( "タングル湿林"), ToFishingBait("レインボースプーン"), WeatherType.妖霧),
                ...
                new Fish("クノ・ザ・キラー", ToFishingSpot( "唄う裂谷北部"), ToFishingBait("ハニーワーム"), WeatherType.妖霧, "(要ジャノ×1) ハニーワーム⇒銀魚HQ⇒アサシンベタHQ⇒"),

                // アバラシア雲海
                new Fish("出目金", ToFishingSpot( "ヴール・シアンシラン"), ToFishingBait("ブルートリーチ"), 9, 15),
                new Fish("カイマン", new[]{ ToFishingSpot( "ヴール・シアンシラン"), ToFishingSpot( "餌食の台地") }, ToFishingBait("ブレーデッドジグ"), 18, 21, "ブレーデッドジグ⇒ブルフロッグHQ⇒"),
                new Fish("水墨魚", ToFishingSpot( "ヴール・シアンシラン"), ToFishingBait("ブルートリーチ"), 14, 16, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("バヌバヌヘッド", ToFishingSpot( "雲溜まり"), ToFishingBait("ブレーデッドジグ"), WeatherType.晴れ | WeatherType.快晴),
                new Fish("ゲイラキラー", ToFishingSpot( "雲溜まり"), ToFishingBait("ブルートリーチ"), WeatherType.晴れ | WeatherType.快晴),
                new Fish("パイッサキラー", ToFishingSpot( "雲溜まり"), ToFishingBait("ブレーデッドジグ"), 8, 12, WeatherType.霧, WeatherType.快晴, "ブレーデッドジグ⇒ブルフロッグHQ⇒"),
                new Fish("スターフラワー", new [] { ToFishingSpot( "クラウドトップ"), ToFishingSpot( "モック・ウーグル島") },ToFishingBait("レッドバルーン"), WeatherType.快晴 | WeatherType.晴れ),
                new Fish("フリーシーモトロ", ToFishingSpot( "クラウドトップ"), ToFishingBait("ジャンボガガンボ"), WeatherType.快晴 | WeatherType.晴れ),
                new Fish("シーロストラタスモトロ", ToFishingSpot( "クラウドトップ"), ToFishingBait("ジャンボガガンボ"), 10, 13, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("ストームコア", ToFishingSpot( "ブルーウィンドウ"), ToFishingBait("レッドバルーン"), WeatherType.風 | WeatherType.曇り | WeatherType.霧),
                new Fish("ザ・セカンドワン", ToFishingSpot( "ブルーウィンドウ"), ToFishingBait("ジャンボガガンボ"), WeatherType.風),
                new Fish("天空珊瑚", ToFishingSpot( "モック・ウーグル島"), ToFishingBait("ジャンボガガンボ"), 0, 6, WeatherType.快晴 | WeatherType.晴れ, "(要引っ掛け釣り)"),
                new Fish("バスキングシャーク", ToFishingSpot( "モック・ウーグル島"), ToFishingBait("ジャンボガガンボ"), WeatherType.霧, WeatherType.快晴, "ジャンボガガンボ⇒スカイフェアリー・セレネHQ⇒"),
                new Fish("クラウドバタフライ", ToFishingSpot( "モック・ウーグル島"), new[]{ ToFishingBait("ジャンボガガンボ"), ToFishingBait("レッドバルーン") }, 5, 7, WeatherType.快晴, "(要スコーピオンフライ×3) ジャンボガガンボ⇒\n(要スカイフェアリー・セレネ×3) レッドバルーン⇒\nジャンボガガンボ⇒(プレ)"),

                // アジス・ラー
                new Fish("ブラッドスキッパー", new[]{ ToFishingSpot( "アルファ管区"), ToFishingSpot( "廃液溜まり") }, ToFishingBait("バイオレットワーム"), WeatherType.雷),
                new Fish("ハイアラガンクラブ改", ToFishingSpot( "アルファ管区"), ToFishingBait("バイオレットワーム"), "バイオレットワーム⇒白金魚HQ⇒"),
                new Fish("魔科学物質666", ToFishingSpot( "廃液溜まり"), ToFishingBait("バイオレットワーム"), WeatherType.晴れ | WeatherType.曇り | WeatherType.雷, "(要フィッシュアイ)バイオレットワーム⇒白金魚HQ⇒(プレ)"),
                new Fish("オイルイール", new []{ ToFishingSpot( "超星間交信塔"), ToFishingSpot( "アジス・ラー旗艦島") }, ToFishingBait("バイオレットワーム"), WeatherType.雷, "バイオレットワーム⇒白金魚HQ⇒"),
                new Fish("オリファントノーズ", ToFishingSpot( "超星間交信塔"), ToFishingBait("バイオレットワーム"), 18, 0, WeatherType.雷),
                new Fish("セティ", ToFishingSpot( "超星間交信塔"), ToFishingBait("バイオレットワーム"), 18, 22, WeatherType.曇り, WeatherType.雷, "(要フィッシュアイ)"),
                new Fish("バイオピラルク", ToFishingSpot( "デルタ管区"), ToFishingBait("ブルートリーチ"), 18, 3, WeatherType.曇り),
                new Fish("バイオガピラルク", ToFishingSpot( "デルタ管区"), ToFishingBait("ツチグモ"), 21, 2, WeatherType.曇り, "ツチグモ⇒(プレ)エーテルアイHQ⇒(スト)"),
                new Fish("プチアクソロトル", ToFishingSpot( "パプスの大樹"), ToFishingBait("ブルートリーチ"), 21, 0),
                new Fish("肺魚", ToFishingSpot( "パプスの大樹"), ToFishingBait("ブルートリーチ"), WeatherType.曇り),
                new Fish("ハンドレッドアイ", ToFishingSpot( "パプスの大樹"), ToFishingBait("ツチグモ"), 6, 10, WeatherType.晴れ | WeatherType.曇り | WeatherType.雷, "ツチグモ⇒エーテルアイHQ⇒(プレ)"),
                new Fish("トゥプクスアラ", ToFishingSpot( "ハビスフィア"), ToFishingBait("ジャンボガガンボ"), 15, 18, "ジャンボガガンボ⇒スカイハイフィッシュHQ⇒"),
                new Fish("スチュペンデミス", ToFishingSpot( "ハビスフィア"), ToFishingBait("ジャンボガガンボ"), WeatherType.晴れ | WeatherType.曇り | WeatherType.雷),
                new Fish("クリスタルピジョン", ToFishingSpot( "ハビスフィア"), ToFishingBait("ジャンボガガンボ"), WeatherType.晴れ, WeatherType.雷, "(要フィッシュアイ)ジャンボガガンボ⇒スカイハイフィッシュHQ⇒"),
                new Fish("ジュエリージェリー", ToFishingSpot( "アジス・ラー旗艦島"), ToFishingBait("バイオレットワーム"), 20, 3),
                new Fish("バレルアイ", ToFishingSpot( "アジス・ラー旗艦島"), ToFishingBait("バイオレットワーム"),  WeatherType.雷, "(要フィッシュアイ)バイオレットワーム⇒白金魚HQ⇒"),
                new Fish("オプロプケン", ToFishingSpot( "アジス・ラー旗艦島"), ToFishingBait("バイオレットワーム"),  WeatherType.雷, "バイオレットワーム⇒白金魚HQ⇒"),
                new Fish("アラガンブレード・シャーク", ToFishingSpot( "アジス・ラー旗艦島"), ToFishingBait("バイオレットワーム"), WeatherType.曇り, WeatherType.雷, "バイオレットワーム⇒白金魚HQ⇒"),
                new Fish("オパビニア", ToFishingSpot( "アジス・ラー旗艦島"), ToFishingBait("バイオレットワーム"), WeatherType.雷, "(要 オプロプケン×3, 要フィッシュアイ) バイオレットワーム⇒\nバイオレットワーム⇒オプロプケンHQ⇒白金魚HQ⇒"),

                // 高地ドラヴァニア
                new Fish("ピピラ・ピラ", new[]{ ToFishingSpot( "悲嘆の飛泉"), ToFishingSpot( "ウィロームリバー"),ToFishingSpot( "餌食の台地") }, ToFishingBait("ゴブリンジグ"), WeatherType.砂塵 | WeatherType.曇り | WeatherType.霧),
                new Fish("草魚", ToFishingSpot( "悲嘆の飛泉"), ToFishingBait("ゴブリンジグ"), WeatherType.砂塵 | WeatherType.曇り | WeatherType.霧),
                new Fish("アカザ", new[]{ ToFishingSpot( "悲嘆の飛泉"), ToFishingSpot( "ウィロームリバー"), ToFishingSpot( "スモーキングウェイスト") }, ToFishingBait("ブルートリーチ"), WeatherType.砂塵 | WeatherType.曇り | WeatherType.霧),
                new Fish("スケイルリッパー", ToFishingSpot( "悲嘆の飛泉"), ToFishingBait("ブルートリーチ"), WeatherType.砂塵 | WeatherType.曇り | WeatherType.霧),
                new Fish("ドラヴァニアンバス", ToFishingSpot( "ウィロームリバー"), ToFishingBait("ブルートリーチ"), 0, 6, WeatherType.砂塵 | WeatherType.曇り | WeatherType.霧),
                new Fish("フォークタン", ToFishingSpot( "ウィロームリバー"), ToFishingBait("ブルートリーチ"), 12, 16, WeatherType.砂塵 | WeatherType.曇り, WeatherType.快晴),
                new Fish("ポリプテルス", ToFishingSpot( "スモーキングウェイスト"), ToFishingBait("ブルートリーチ"), 21, 3),
                new Fish("アクムノタネ", ToFishingSpot( "スモーキングウェイスト"), ToFishingBait("ブルートリーチ"), 22, 2, WeatherType.砂塵 | WeatherType.霧 | WeatherType.曇り),
                new Fish("サンダーボルト", ToFishingSpot( "餌食の台地"), ToFishingBait("ブレーデッドジグ"), 22, 4),
                new Fish("サンダースケイル", ToFishingSpot( "餌食の台地"), ToFishingBait("ストーンラーヴァ"), 6, 8, WeatherType.砂塵 | WeatherType.曇り | WeatherType.霧, WeatherType.雷, "ストーンラーヴァ⇒マクロブラキウムHQ⇒"),
                new Fish("アンバーサラマンダー", ToFishingSpot( "餌食の台地"), ToFishingBait("ブルートリーチ"), 6, 12),
                new Fish("メテオトータス", ToFishingSpot( "モーン大岩窟"), ToFishingBait("マグマワーム"), WeatherType.快晴 | WeatherType.晴れ, "マグマワーム⇒グラナイトクラブHQ⇒"),
                new Fish("聖竜の涙", ToFishingSpot( "モーン大岩窟西"), ToFishingBait("マグマワーム"), 2, 6, "(要フィッシュアイ)"),
                new Fish("マグマラウス", ToFishingSpot( "アネス・ソー"), ToFishingBait("マグマワーム"), 18, 6, "マグマワーム⇒グラナイトクラブHQ⇒"),
                new Fish("リドル", ToFishingSpot( "アネス・ソー"), ToFishingBait("マグマワーム"), 8, 16, WeatherType.快晴 | WeatherType.晴れ, WeatherType.快晴, "(要フィッシュアイ) マグマワーム⇒グラナイトクラブHQ⇒"),
                new Fish("ラーヴァスネイル", ToFishingSpot( "光輪の祭壇"), ToFishingBait("マグマワーム"), WeatherType.快晴 | WeatherType.晴れ),
                new Fish("溶岩王", ToFishingSpot( "光輪の祭壇"), ToFishingBait("マグマワーム"), 10, 17, WeatherType.快晴 | WeatherType.晴れ, "(要フィッシュアイ)マグマワーム⇒グラナイトクラブHQ⇒"),
                new Fish("溶岩帝王", ToFishingSpot( "光輪の祭壇"), ToFishingBait("マグマワーム"), 8, 16, WeatherType.砂塵 | WeatherType.曇り | WeatherType.霧, WeatherType.快晴 | WeatherType.晴れ, "(要フィッシュアイ)マグマワーム⇒グラナイトクラブHQ⇒(スト)"),
                new Fish("プロブレマティカス", ToFishingSpot( "光輪の祭壇"), ToFishingBait("マグマワーム"), 10, 15, WeatherType.快晴 | WeatherType.晴れ, "(要フォッシルアロワナ×3, 要フィッシュアイ, 時間帯不問) マグマワーム⇒グラナイトクラブHQ⇒\n(要グラナイトクラブ×5) マグマワーム⇒\nマグマワーム⇒グラナイトクラブHQ⇒"),

                // 低地ドラヴァニア
                new Fish("水瓶王", ToFishingSpot( "サリャク河"), ToFishingBait("ブレーデッドジグ"), "ブレーデッドジグ⇒香魚HQ⇒"),
                new Fish("マダムバタフライ", ToFishingSpot( "クイックスピル・デルタ"), ToFishingBait("ツチグモ"), 21, 2, WeatherType.快晴, "ツチグモ⇒グリロタルパHQ⇒"),
                new Fish("フィロソファーアロワナ", ToFishingSpot( "サリャク河上流"), ToFishingBait("ブルートリーチ"), 13, 20, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("アブトアード", ToFishingSpot( "サリャク河上流"), ToFishingBait("ブルートリーチ"), WeatherType.霧 | WeatherType.曇り),
                new Fish("スピーカー", ToFishingSpot( "サリャク河上流"), ToFishingBait("ストーンラーヴァ"), 16, 8, WeatherType.曇り | WeatherType.霧, WeatherType.暴雨, "ストーンラーヴァ⇒グリロタルパHQ⇒"),
                ...
                new Fish("サリャクカイマン", ToFishingSpot( "サリャク河中州"), ToFishingBait("ブレーデッドジグ"), 15, 18, "ブレーデッドジグ⇒ブルフロッグHQ⇒"),
                new Fish("バーサーカーベタ", ToFishingSpot( "サリャク河中州"), ToFishingBait("ブルートリーチ"), WeatherType.快晴 | WeatherType.晴れ),
                new Fish("ゴブリバス", ToFishingSpot( "サリャク河中州"), ToFishingBait("ブルートリーチ"), 0, 6, WeatherType.曇り, WeatherType.霧),
                new Fish("万能のゴブリバス", ToFishingSpot( "サリャク河中州"), ToFishingBait("ブルートリーチ"), 2, 6, WeatherType.雨, WeatherType.暴雨, "ブルートリーチ⇒香魚HQ⇒"),

                // ドラヴァニア雲海
                new Fish("キッシング・グラミー", ToFishingSpot( "エイル・トーム"), ToFishingBait("ストーンラーヴァ"), 9, 0),
                new Fish("ヴィゾーヴニル", ToFishingSpot( "エイル・トーム"), ToFishingBait("ブルートリーチ"), 8, 9),
                new Fish("モグルグポンポン", ToFishingSpot( "グリーンスウォード島"), ToFishingBait("ブルートリーチ"), 10, 13, WeatherType.暴風, WeatherType.快晴, "※ポンポンポンが釣れたらトレードリリース"),
                new Fish("サカサナマズ", ToFishingSpot( "ウェストン・ウォーター"), ToFishingBait("ストーンラーヴァ"), 16, 19),
                new Fish("アミア・カルヴァ", ToFishingSpot( "ウェストン・ウォーター"), ToFishingBait("ブルートリーチ"), 8, 12),
                new Fish("ボサボサ", ToFishingSpot( "ウェストン・ウォーター"), ToFishingBait("ブルートリーチ"), WeatherType.曇り, WeatherType.暴風, "(要フィッシュアイ)"),
                new Fish("サンセットセイル", ToFishingSpot( "ランドロード遺構"), ToFishingBait("ジャンボガガンボ"), 15, 17, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("ラタトスクソウル", ToFishingSpot( "ランドロード遺構"), ToFishingBait("ジャンボガガンボ"), 4, 6, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("プテラノドン", ToFishingSpot( "ソーム・アル笠雲"), ToFishingBait("ジャンボガガンボ"), 9, 17),
                ...
                new Fish("マナセイル", ToFishingSpot( "サルウーム・カシュ"), ToFishingBait("ジャンボガガンボ"), 10, 14, WeatherType.快晴 | WeatherType.晴れ, "ジャンボガガンボ⇒スカイフェアリー・セレネHQ⇒"),
                new Fish("ブラウンブーメラン", ToFishingSpot( "サルウーム・カシュ"), ToFishingBait("レッドバルーン"), WeatherType.曇り),
                new Fish("ストームブラッドライダー", ToFishingSpot( "サルウーム・カシュ"), ToFishingBait("ジャンボガガンボ"), WeatherType.快晴, WeatherType.暴風, "(要フィッシュアイ)"),
                new Fish("ランデロプテルス", ToFishingSpot( "サルウーム・カシュ"), ToFishingBait("ジャンボガガンボ"), 5, 8, WeatherType.暴風, "(要スカイハイフィッシュ×5) ジャンボガガンボ⇒\nジャンボガガンボ⇒スカイハイフィッシュHQ⇒"),

                // ラールガーズリーチ
                new Fish("ミューヌフィッシュ", new []{ ToFishingSpot( "ミラージュクリーク上流"), ToFishingSpot( "ティモン川"), ToFishingSpot( "夜の森") }, ToFishingBait("赤虫"), WeatherType.曇り | WeatherType.霧, "赤虫⇒ギラバニアントラウトHQ⇒"),
                new Fish("フックスティーラー", ToFishingSpot( "ミラージュクリーク上流"), ToFishingBait("赤虫"), "赤虫⇒ギラバニアントラウトHQ⇒"),
                new Fish("シデンナマズ", ToFishingSpot( "ラールガーズリーチ"), ToFishingBait("赤虫"), WeatherType.雷, "赤虫⇒ギラバニアントラウトHQ⇒"),
                new Fish("レッドテイル", ToFishingSpot( "星導山寺院入口"), ToFishingBait("ドバミミズ"), WeatherType.曇り | WeatherType.霧, "ドバミミズ⇒バルーンフロッグHQ⇒(スト)"),
                new Fish("レッドテイルゾンビー", ToFishingSpot( "星導山寺院入口"), ToFishingBait("ドバミミズ"), 8, 12, WeatherType.曇り, "ドバミミズ⇒バルーンフロッグHQ⇒(スト)"),

                // ギラバニア辺境地帯
                new Fish("サーメットヘッド", ToFishingSpot( "ティモン川"), ToFishingBait("ザザムシ"), 16, 20),
                new Fish("クセナカンサス", ToFishingSpot( "ティモン川"), ToFishingBait("ザザムシ"), 16, 20, "ザザムシ⇒サーメットヘッドHQ⇒"),
                new Fish("レイスフィッシュ", ToFishingSpot( "夜の森"), ToFishingBait("ザザムシ"), 0, 4, WeatherType.霧),
                new Fish("サファイアファン", ToFishingSpot( "夜の森"), ToFishingBait("ザザムシ"), WeatherType.雷),
                new Fish("小流星", ToFishingSpot( "流星の尾"), ToFishingBait("サスペンドミノー"), WeatherType.霧 | WeatherType.曇り),
                new Fish("ハンテンナマズ", ToFishingSpot( "流星の尾"), ToFishingBait("イクラ"), 16, 19),
                new Fish("ニルヴァーナクラブ", ToFishingSpot( "流星の尾"), ToFishingBait("サスペンドミノー"), WeatherType.霧 | WeatherType.曇り),
                new Fish("カーディナルフィッシュ", ToFishingSpot( "流星の尾"), ToFishingBait("サスペンドミノー"), 19, 23, WeatherType.霧 | WeatherType.曇り),
                new Fish("アークビショップフィッシュ", ToFishingSpot( "流星の尾"), ToFishingBait("サスペンドミノー"), 12, 16),
                new Fish("タニクダリ", ToFishingSpot( "ベロジナ川"), ToFishingBait("ザザムシ"), WeatherType.霧),
                new Fish("ミラージュマヒ", ToFishingSpot( "ミラージュクリーク"), ToFishingBait("サスペンドミノー"), 4, 8, WeatherType.晴れ | WeatherType.快晴),
                new Fish("コープスチャブ", ToFishingSpot( "ミラージュクリーク"), ToFishingBait("サスペンドミノー"), 20, 0, WeatherType.快晴),


                // ギラバニア山岳地帯
                new Fish("ボンドスプリッター", ToFishingSpot( "夫婦池"), ToFishingBait("サスペンドミノー"), WeatherType.砂塵),
                new Fish("ドレパナスピス", ToFishingSpot( "夫婦池"), ToFishingBait("サスペンドミノー"), WeatherType.砂塵, "(要ボンドスプリッター×2) サスペンドミノー⇒\nサスペンドミノー⇒(スト)"),
                new Fish("ナガレクダリ", ToFishingSpot( "スロウウォッシュ"), ToFishingBait("赤虫"), 8, 12, "赤虫⇒ギラバニアントラウトHQ⇒"),
                new Fish("スティールシャーク", ToFishingSpot( "ヒース滝"), ToFishingBait("ザザムシ"), WeatherType.快晴),
                new Fish("ラストティアー", ToFishingSpot( "ヒース滝"), ToFishingBait("イクラ"), WeatherType.霧, WeatherType.晴れ),

                new Fish("瞑想魚", new [] { ToFishingSpot( "裁定者の像"), ToFishingSpot( "ブルズバス") }, ToFishingBait("ザザムシ"), WeatherType.曇り | WeatherType.風 | WeatherType.霧 | WeatherType.砂塵),
                new Fish("裁定魚", ToFishingSpot( "裁定者の像"), ToFishingBait("ザザムシ"), WeatherType.風),
                new Fish("解脱魚", ToFishingSpot( "裁定者の像"), ToFishingBait("サスペンドミノー"), WeatherType.曇り | WeatherType.風 | WeatherType.霧 | WeatherType.砂塵, WeatherType.快晴),
                new Fish("ブルズバイト", ToFishingSpot( "ブルズバス"), ToFishingBait("サスペンドミノー"), WeatherType.曇り | WeatherType.風 | WeatherType.霧 | WeatherType.砂塵),
                new Fish("ワニガメ", ToFishingSpot( "ブルズバス"), ToFishingBait("サスペンドミノー"), WeatherType.晴れ | WeatherType.快晴),
                new Fish("ヘモン", ToFishingSpot( "ブルズバス"), ToFishingBait("サスペンドミノー"), 16, 20, WeatherType.曇り),
                new Fish("イースタンパイク", ToFishingSpot( "アームズ・オブ・ミード"), ToFishingBait("活海老"), WeatherType.晴れ | WeatherType.快晴),
                new Fish("ロックフィッシュ", ToFishingSpot( "アームズ・オブ・ミード"), ToFishingBait("サスペンドミノー"), 12, 16, WeatherType.曇り | WeatherType.風 | WeatherType.霧 | WeatherType.砂塵),
                new Fish("アラミガンベール", ToFishingSpot( "アームズ・オブ・ミード"), ToFishingBait("サスペンドミノー"), WeatherType.快晴, WeatherType.晴れ),

                // ギラバニア湖畔地帯
                new Fish("ソルトミル", ToFishingSpot( "ロッホ・セル湖"), ToFishingBait("蚕蛹"), WeatherType.曇り | WeatherType.霧, "蚕蛹⇒ロックソルトフィッシュHQ⇒"),
                new Fish("スカルプター", ToFishingSpot( "ロッホ・セル湖"), ToFishingBait("蚕蛹"), 12, 18, WeatherType.雷雨, "蚕蛹⇒ロックソルトフィッシュHQ⇒"),
                new Fish("ダイヤモンドアイ", ToFishingSpot( "ロッホ・セル湖"), ToFishingBait("蚕蛹"), WeatherType.快晴, "(要フィッシュアイ)蚕蛹⇒ロックソルトフィッシュHQ⇒"),
                new Fish("ステタカントゥス", ToFishingSpot( "ロッホ・セル湖"), ToFishingBait("蚕蛹"), 16, 18, WeatherType.雷雨, "(要スカルプター×2, 要フィッシュアイ) 蚕蛹⇒ロックソルトフィッシュHQ⇒\n(天候不問, ET16:00～17:59, フィッシュアイ不要)蚕蛹⇒ロックソルトフィッシュHQ⇒"),

                // 紅玉海
                new Fish("クアル", ToFishingSpot( "紅玉台場近海"), ToFishingBait("アオイソメ"), 0, 8, WeatherType.雷, WeatherType.曇り),
                new Fish("紅龍", ToFishingSpot( "紅玉台場近海"), ToFishingBait("アオイソメ"), 4, 8, WeatherType.雷, WeatherType.曇り, "アオイソメ⇒クアルHQ⇒(スト)"),
                new Fish("鰭竜", ToFishingSpot( "獄之蓋近海"), ToFishingBait("活海老"), WeatherType.雷, "活海老⇒紅玉海老HQ⇒"),
                new Fish("ウキキ", ToFishingSpot( "獄之蓋近海"), ToFishingBait("アオイソメ"), 8, 12, WeatherType.風),
                new Fish("菜食王", ToFishingSpot( "獄之蓋近海"), ToFishingBait("活海老"), 20, 0, WeatherType.雷, "活海老⇒紅玉海老HQ⇒(スト)"),
                new Fish("オオテンジクザメ", ToFishingSpot( "ベッコウ島近海"), ToFishingBait("アオイソメ"), 10, 18, WeatherType.快晴),
                new Fish("ナナツボシ", ToFishingSpot( "ベッコウ島近海"), ToFishingBait("アオイソメ"), 10, 18, WeatherType.雷, WeatherType.晴れ),
                new Fish("春不知", ToFishingSpot( "沖之岩近海"), ToFishingBait("アオイソメ"), 16, 20),
                new Fish("メカジキ", ToFishingSpot( "オノコロ島近海"), ToFishingBait("アオイソメ"), 8, 12, WeatherType.風 | WeatherType.曇り, "(要フィッシュアイ)"),
                new Fish("ウミダイジャ", ToFishingSpot( "オノコロ島近海"), ToFishingBait("活海老"), WeatherType.風, "活海老⇒紅玉海老HQ⇒"),
                new Fish("ギマ", ToFishingSpot( "イサリ村沿岸"), ToFishingBait("アオイソメ"), 5, 7),
                new Fish("バリマンボン", ToFishingSpot( "イサリ村沿岸"), ToFishingBait("活海老"), 16, 0, WeatherType.快晴 | WeatherType.晴れ, WeatherType.雷),
                new Fish("ソクシツキ", ToFishingSpot( "ゼッキ島近海"), ToFishingBait("活海老"), WeatherType.雷, "活海老⇒紅玉海老HQ⇒"),

                // ヤンサ
                new Fish("ザクロウミ", ToFishingSpot( "アオサギ池"), ToFishingBait("ドバミミズ"), WeatherType.雨),
                new Fish("オニニラミ", ToFishingSpot( "アオサギ川"), ToFishingBait("サスペンドミノー"), WeatherType.晴れ, WeatherType.快晴),
                new Fish("仙寿の翁", ToFishingSpot( "ナマイ村溜池"), ToFishingBait("ザザムシ"), 20, 0, WeatherType.快晴, "※ノゴイが釣れたらトレードリリース"),
                new Fish("シャジクノミ", ToFishingSpot( "無二江東"), ToFishingBait("ザザムシ"), 0, 6, WeatherType.曇り, WeatherType.晴れ),
                new Fish("天女魚", ToFishingSpot( "無二江西"), ToFishingBait("ザザムシ"), 16, 0),
                new Fish("羽衣美女", ToFishingSpot( "無二江西"), ToFishingBait("ザザムシ"), WeatherType.曇り, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("パンダ蝶尾", ToFishingSpot( "梅泉郷"), ToFishingBait("赤虫"), 10, 18, "(要フィッシュアイ)"),
                new Fish("絹鯉", ToFishingSpot( "梅泉郷"), ToFishingBait("ザザムシ"), 4, 8, WeatherType.雨, "(要フィッシュアイ)"),
                new Fish("羽衣鯉", ToFishingSpot( "梅泉郷"), ToFishingBait("ザザムシ"), WeatherType.霧, "(要フィッシュアイ)"),
                new Fish("ドマウナギ", ToFishingSpot( "七彩渓谷"), ToFishingBait("赤虫"), 17, 10),
                new Fish("ニジノヒトスジ", ToFishingSpot( "七彩渓谷"), ToFishingBait("サスペンドミノー"), 12, 16, WeatherType.霧),
                new Fish("紫彩魚", ToFishingSpot( "七彩溝"), ToFishingBait("ザザムシ"), 0, 4),
                new Fish("赤彩魚", ToFishingSpot( "七彩溝"), ToFishingBait("ザザムシ"), 4, 8),
                new Fish("橙彩魚", ToFishingSpot( "七彩溝"), ToFishingBait("ザザムシ"), 4, 8, "ザザムシ⇒赤彩魚HQ⇒"),
                new Fish("藍彩魚", ToFishingSpot( "七彩溝"), ToFishingBait("ザザムシ"), 0, 4, "ザザムシ⇒紫彩魚HQ⇒"),
                new Fish("緑彩魚", ToFishingSpot( "七彩溝"), ToFishingBait("ザザムシ"), 0, 16, WeatherType.晴れ, WeatherType.晴れ | WeatherType.快晴),
                new Fish("七彩天主", ToFishingSpot( "七彩溝"), ToFishingBait("ザザムシ"), 0, 16, WeatherType.晴れ, WeatherType.晴れ | WeatherType.快晴, "(要 藍彩魚×3, ET 00:00～03:59) ザザムシ⇒紫彩魚HQ⇒\n(要 橙彩魚×3, ET 4:00-7:59) ザザムシ⇒赤彩魚HQ⇒\n(要 緑彩魚×5, ET 00:00～15:59, 晴れ⇒晴れ/快晴) ザザムシ⇒\n(天候不問, 時間帯不問) ザザムシ⇒"),
                new Fish("無二草魚", ToFishingSpot( "城下船場"), ToFishingBait("赤虫"), 20, 4),
                new Fish("水天一碧", ToFishingSpot( "城下船場"), ToFishingBait("ザザムシ"), 16, 0, WeatherType.暴雨),
                new Fish("雷遁魚", ToFishingSpot( "ドマ城前"), ToFishingBait("ザザムシ"), WeatherType.雨 | WeatherType.暴雨),
                new Fish("ボクデン", ToFishingSpot( "ドマ城前"), ToFishingBait("ザザムシ"), 12, 14),

                // アジムステップ
                new Fish("メダカ", new[]{ ToFishingSpot( "ネム・カール"), ToFishingSpot( "シロガネ水路") }, ToFishingBait("ザザムシ"), WeatherType.快晴),
                new Fish("ベジースキッパー", ToFishingSpot( "ネム・カール"), ToFishingBait("赤虫"), 8, 12, WeatherType.晴れ, WeatherType.快晴, "(プレ)"),
                new Fish("ハクビターリング", ToFishingSpot( "ハク・カール"), ToFishingBait("ザザムシ"), 0, 4, WeatherType.雨),
                new Fish("明けの旗魚", ToFishingSpot( "ハク・カール"), ToFishingBait("ドバミミズ"), 0, 8, WeatherType.晴れ, WeatherType.霧, "ドバミミズ⇒ザガスHQ⇒(スト)"),
                new Fish("ブレードスキッパー", ToFishingSpot( "ヤト・カール上流"), ToFishingBait("サスペンドミノー"), 4, 8, WeatherType.霧),
                new Fish("グッピー", ToFishingSpot( "アジム・カート"), ToFishingBait("ザザムシ"), 16, 20, WeatherType.晴れ, WeatherType.快晴),
                new Fish("暮れの魚", ToFishingSpot( "アジム・カート"), ToFishingBait("ドバミミズ"), 8, 16, WeatherType.雨 | WeatherType.暴風, WeatherType.曇り, "ドバミミズ⇒ザガスHQ⇒"),
                new Fish("川の長老", ToFishingSpot( "タオ・カール"), ToFishingBait("ドバミミズ"), WeatherType.曇り, WeatherType.風 | WeatherType.霧, "ドバミミズ⇒ザガスHQ⇒"),
                new Fish("シンタクヤブリ", ToFishingSpot( "タオ・カール"), ToFishingBait("ザザムシ"), 20, 0),
                new Fish("ヤトカガン", ToFishingSpot( "ヤト・カール下流"), ToFishingBait("ザザムシ"), WeatherType.風),
                new Fish("ナーマの愛寵", ToFishingSpot( "ドタール・カー"), ToFishingBait("サスペンドミノー"), 4, 8, WeatherType.雨, WeatherType.晴れ | WeatherType.快晴),
                new Fish("神々の愛", ToFishingSpot( "ドタール・カー"), ToFishingBait("ザザムシ"), 5, 7, WeatherType.雨, WeatherType.快晴, "(プレ)\n※ナーマの恵みが釣れたらトレードリリース"),

                // クガネ
                new Fish("ノボリリュウ", ToFishingSpot( "波止場全体"), ToFishingBait("活海老"), "活海老⇒紅玉海老HQ⇒"),

                // シロガネ
                new Fish("バクチウチ", ToFishingSpot( "シロガネ"), ToFishingBait("アオイソメ")),
                new Fish("ヒメダカ", ToFishingSpot( "シロガネ水路"), ToFishingBait("ドバミミズ"), 4, 6),

                // クリスタリウム
                new Fish("ペンダントヘッド", ToFishingSpot( "クリスタリウム居室"), ToFishingBait("蟲箱"), 18, 22, "(プレ)"),

                // ユールモア
                new Fish("グランドデイムバタフライ", ToFishingSpot( "廃船街"), ToFishingBait("イカの切り身"), 12, 19, WeatherType.快晴),

                // レイクランド
                new Fish("プラチナグッピー", ToFishingSpot( "錆ついた貯水池"), ToFishingBait("蟲箱"), WeatherType.快晴),
                new Fish("アンフォーギヴン・クラブ", ToFishingSpot( "始まりの湖"), ToFishingBait("蟲箱"), WeatherType.霧),
                new Fish("イモータルジョー", ToFishingSpot( "ケンの島 (釣り)"), ToFishingBait("蟲箱"), 16, 0, WeatherType.晴れ | WeatherType.快晴, WeatherType.曇り | WeatherType.霧),

                // コルシア島
                new Fish("ホワイトロンゾ", ToFishingSpot( "ワッツリバー下流"), ToFishingBait("蟲箱"), 0, 2, "(プレ)"),
                new Fish("ブロンズソール", ToFishingSpot( "シャープタンの泉"), ToFishingBait("マーブルラーヴァ"), WeatherType.雨),
                new Fish("ヘノドゥス", ToFishingSpot( "コルシア島沿岸東"), ToFishingBait("ショートビルミノー"), 16, 0, WeatherType.曇り | WeatherType.霧, "ショートビルミノー⇒スピアヘッドHQ⇒(プレ)"),

                // アム・アレーン
                new Fish("カンムリカブリ", ToFishingSpot( "砂の川"), ToFishingBait("オヴィムジャーキー"), 0, 6, WeatherType.砂塵, "オヴィムジャーキー⇒ツノカブリHQ⇒"),
                new Fish("トゲトカゲ", ToFishingSpot( "アンバーヒル"), ToFishingBait("オヴィムジャーキー"), 10, 18, WeatherType.晴れ | WeatherType.快晴 | WeatherType.灼熱波, "デザートフロッグ⇒ミズカキスナヤモリHQ⇒"),
                new Fish("クギトカゲ", ToFishingSpot( "アンバーヒル"), ToFishingBait("デザートフロッグ"), 12, 16, WeatherType.快晴, "デザートフロッグ⇒ミズカキスナヤモリHQ⇒"),

                // イル・メグ
                new Fish("フューリィベタ", ToFishingSpot( "姿見の湖"), ToFishingBait("蟲箱"), 20, 0, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("ピクシーレインボー", ToFishingSpot( "中の子らの流れ"), ToFishingBait("マーブルラーヴァ"), WeatherType.晴れ | WeatherType.快晴, WeatherType.霧, "(プレ)"),
                new Fish("水泡眼", ToFishingSpot( "コラードの排水溝"), ToFishingBait("蟲箱"), WeatherType.快晴),

                // ラケティカ大森林
                new Fish("ロックワの衛士", ToFishingSpot( "トゥシ・メキタ湖"), ToFishingBait("ロバーボール"), 10, 12, "ロバーボール⇒クラウンテトラHQ⇒エリオプスHQ⇒"),
                new Fish("ダイヤモンドピピラ", ToFishingSpot( "血の酒坏"), ToFishingBait("ロバーボール"), 12, 20),
                new Fish("ブラックジェットストリーム", ToFishingSpot( "ロツァトル川"), ToFishingBait("ロバーボール"), 2, 12, WeatherType.曇り, WeatherType.晴れ, "(プレ)"),
                new Fish("常闇魚", ToFishingSpot( "ウォーヴンオウス"), ToFishingBait("ロバーボール"), 0, 8, "(要フィッシュアイ)"),

                // テンペスト
                new Fish("オンドの溜息", ToFishingSpot( "フラウンダーの穴蔵"), ToFishingBait("イカの切り身"), 12, 14, WeatherType.快晴 | WeatherType.晴れ),
                new Fish("アーポアク", ToFishingSpot( "キャリバンの古巣穴西"), ToFishingBait("イカの切り身"), 12, 16, WeatherType.快晴, "(要フィッシュアイ)イカの切り身⇒エンシェントシュリンプHQ⇒(プレ)"),
                new Fish("フードウィンカー", new[] { ToFishingSpot( "キャリバン海底谷北西"), ToFishingSpot( "キャリバンの古巣穴東") }, ToFishingBait("ショートビルミノー"), WeatherType.晴れ),
                new Fish("スターチェイサー", ToFishingSpot( "プルプラ洞"), ToFishingBait("イカの切り身"), 6, 10, WeatherType.曇り, "(要フィッシュアイ)"),
            })
            {
                _fishes.Add(fish);
            }
