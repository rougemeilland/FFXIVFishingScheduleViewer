...
namespace FFXIVFishingScheduleViewer
{
    ...
    {
        private static IEnumerable<FishingSpotPageIdElement> GetPageIdSourceOfCBH()
        {
            return
                new[]
                {
                ...
                .Select(item => new FishingSpotPageIdElement { spotId = item.spotId, pageId = item.pageId });
        }
    }
}
